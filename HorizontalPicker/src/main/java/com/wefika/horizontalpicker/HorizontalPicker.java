...
public class HorizontalPicker extends View {
     ...
     */
    protected static final int SELECTOR_MAX_FLING_VELOCITY_ADJUSTMENT = 4;
    ...
    protected BoringLayout[] mLayouts;

    protected TextPaint mTextPaint;
    protected BoringLayout.Metrics mBoringMetrics;
    protected TextUtils.TruncateAt mEllipsize;

    protected int mItemWidth;
    protected RectF mItemClipBounds;
    protected RectF mItemClipBoundsOffser;

    protected float mLastDownEventX;

    protected OverScroller mFlingScrollerX;
    protected OverScroller mAdjustScrollerX;

    protected int mPreviousScrollerX;

    protected boolean mScrollingX;
    protected int mPressedItem = -1;

    protected ColorStateList mTextColor;

    protected OnItemSelected mOnItemSelected;
    protected OnItemClicked mOnItemClicked;

    protected int mSelectedItem;

    protected EdgeEffect mLeftEdgeEffect;
    protected EdgeEffect mRightEdgeEffect;

    protected Marquee mMarquee;
    protected int mMarqueeRepeatLimit = 3;

    protected float mDividerSize = 0;

    protected int mSideItems = 1;

    protected TextDirectionHeuristicCompat mTextDir;

    protected final PickerTouchHelper mTouchHelper;
     ...
     * @return
     */
    protected boolean isRtl(CharSequence text) {
        if (mTextDir == null) {
            mTextDir = getTextDirectionHeuristic();
        }
    ...
    protected TextDirectionHeuristicCompat getTextDirectionHeuristic() {
    ...
    protected void drawEdgeEffect(Canvas canvas, EdgeEffect edgeEffect, int degrees) {
     ...
     */
    protected int getTextColor(int item) {
...
//            postInvalidateOnAnimation(); // TODO
    ...
    protected void flingX(int velocityX) {
    ...
    protected void adjustToNearestItemX() {
    ...
    protected void calculateItemSize(int w, int h) {
    ...
    protected void onScrollerFinishedX(OverScroller scroller) {
    ...
    protected void stopMarqueeIfNeeded() {
    ...
    protected int getPositionOnScreen(float x) {
     ...
     * @return
     */
    protected int getColor(int scrollX, int position) {
        int itemWithPadding = (int) (mItemWidth + mDividerSize);
     ...
     */
    protected int getPositionFromCoordinates(int x) {
     ...
     */
    protected int getRelativeInBound(int x) {
        int scrollX = getScrollX();
     ...
     */
    protected int getInBoundsX(int x) {
    ...
    protected static final class Marquee extends Handler {
        // TODO: Add an option to configure this
        protected static final float MARQUEE_DELTA_MAX = 0.07f;
        protected static final int MARQUEE_DELAY = 1200;
        protected static final int MARQUEE_RESTART_DELAY = 1200;
        protected static final int MARQUEE_RESOLUTION = 1000 / 30;
        protected static final int MARQUEE_PIXELS_PER_SECOND = 30;

        protected static final byte MARQUEE_STOPPED = 0x0;
        protected static final byte MARQUEE_STARTING = 0x1;
        protected static final byte MARQUEE_RUNNING = 0x2;

        protected static final int MESSAGE_START = 0x1;
        protected static final int MESSAGE_TICK = 0x2;
        protected static final int MESSAGE_RESTART = 0x3;

        protected final WeakReference<HorizontalPicker> mView;
        protected final WeakReference<Layout> mLayout;

        protected byte mStatus = MARQUEE_STOPPED;
        protected final float mScrollUnit;
        protected float mMaxScroll;
        protected float mMaxFadeScroll;
        protected float mGhostStart;
        protected float mGhostOffset;
        protected float mFadeStop;
        protected int mRepeatLimit;
    ...
    protected static class PickerTouchHelper extends ExploreByTouchHelper {

        protected HorizontalPicker mPicker;
