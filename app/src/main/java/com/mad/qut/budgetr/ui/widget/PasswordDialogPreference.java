...
import com.mad.qut.budgetr.utils.BCrypt;
...
public class PasswordDialogPreference extends DialogPreference {
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        if (positiveResult) {
            String mNewPassword = mEditPassword.getText().toString();
            if (!mNewPassword.equals("")) {
                // Encrypt password
                //String hashedPassword = BCrypt.hashpw(mNewPassword, BCrypt.gensalt());
                persistString(mNewPassword);
            }
        }
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        myState.value = mEditPassword.getText().toString();
        return myState;
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        mEditPassword.setText(myState.value);
    }
